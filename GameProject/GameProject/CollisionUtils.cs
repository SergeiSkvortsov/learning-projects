    ...
    public static class CollisionUtils
    {
            ...
            Vector2 firstVelocity, Vector2 secondVelocity)
        {
            ...
            else if (collisionSides.Count == 2)
            {
                ...
                // first - second is correct for the checks below
            ...
            {
                // 3 collision sides can occur if a taller object hits a shorter object from the side
                if (collisionSides.Contains(CollisionSide.Top) &&
            ...
            out Rectangle newSecondDrawRectangle)
        {
            ...
            // max distance we need to move apart is the width plus height of the intersection
